...
def test_backend_client_port_get_claude_md_return_is_dict_str_object() -> None:
    """Regression: BackendClientPort.get_claude_md returns dict[str, object], not dict[str, Any]."""
    import typing
    from app.services.run_dispatch_config_preparer import BackendClientPort

    hints = typing.get_type_hints(BackendClientPort.get_claude_md)
...
def test_claude_md_stager_port_stage_return_is_dict_str_object() -> None:
    """Regression: ClaudeMdStagerPort.stage returns dict[str, object], not dict[str, Any]."""
    import typing

    hints = typing.get_type_hints(ClaudeMdStagerPort.stage)
    return_type = hints.get("return")
    assert return_type is not None, "return type not found"
