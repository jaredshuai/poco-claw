...
class SkillStager:
    def __init__(
        ...
        self._storage_service_factory = storage_service_factory or build_skill_storage
        self._workspace_manager = workspace_manager
        self._workspace_manager_factory = (
            workspace_manager_factory or build_skill_workspace_manager
        )

    @property
    def storage_service(self) -> SkillStorage:
        if self._storage_service is None:
            self._storage_service = self._storage_service_factory()
        return self._storage_service

    @storage_service.setter
    def storage_service(self, value: SkillStorage) -> None:
